...
heading1.setAttribute('class', 'h2');
heading1.innerHTML = "HTML TABLE"
...
container.append(heading, form, heading1,divtable);
...
function createMultiSelect() {
    ...
    label.innerHTML = "choise of food";
...
for(var i=0;i<a.length;i++){
    ...
    if(a[i].checked){
        newvar.push(a[i].value);
        count++;
    }
}
if(newvar.length>=2){
    var output=newvar.join(",");
console.log(output)    

}
else{
    output=alert("Choice of Food:(must choose 2 out of 5 options)")
}
